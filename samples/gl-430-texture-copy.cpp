...
namespace
{
	...
	std::string const VERT_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-430/texture-copy.vert");
	std::string const FRAG_SHADER_SOURCE(glf::DATA_DIRECTORY + "gl-430/texture-copy.frag");
